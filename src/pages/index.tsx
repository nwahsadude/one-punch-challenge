                ...
                workouts.map(workout => (
                  <div key={workout} className="border-black border-b-2 pt-2 pb-2">
                    ...
                    <div>
                      ...
                      <button type="button"
                              className="inline-block rounded bg-green-500 px-4 pt-2.5 pb-2 text-xs uppercase leading-normal text-white">Submit
                      </button>
                    </div>
                  </div>
                ))
                ...
                workouts.map(workout => (
                  <div key={workout} className="border-black border-b-2 pt-2 pb-2">
                    ...
                    <div className="w-full bg-neutral-200">
                      <div style={{width: '25%'}} className="h-full bg-green-600">25%</div>
                    </div>
                  </div>
                ))
              }
